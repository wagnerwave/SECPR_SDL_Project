...
const PostList = () => { 
    ...
    useEffect(async() => {
        await axios.post('https://node-back-wghvb3pvea-uc.a.run.app/check-access', body, config)
        .then(response => {
        ...
        await axios.get('https://node-back-wghvb3pvea-uc.a.run.app/posts/get-all', body, config)
        .then(response => {
